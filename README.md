...
The donations for Premium Version are open again. So if you want the autocatcher along with other amazing commands, DM me on Discord @ **Hyperclaw79#7777** for the PayPal details. Scroll down to [Donations section](https://github.com/Hyperclaw79/PokeBall-SelfBot#donations) for details.
